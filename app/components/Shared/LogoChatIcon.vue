<template>
  <NuxtLink to="/chat" aria-label="Back to chat" class="icon-link">
    <svg class="icon" viewBox="0 0 2048 2048" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="matrix(64,0,0,64,-28.16,25.6)">
        <path
