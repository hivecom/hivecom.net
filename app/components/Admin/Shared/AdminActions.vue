...
interface AdminActionsProps {
   ...
   */
  resourceType: 'games' | 'events' | 'network_gameservers' | 'profiles' | 'funding_expenses' | 'referendums' | 'network_servers' | 'assets' | 'projects' | 'discussions' | 'kvstore' | 'motds' | 'themes'
