...
export default defineNuxtConfig({
  ...
  modules: ['@nuxtjs/supabase', '@nuxtjs/sitemap', '@nuxtjs/robots', '@nuxtjs/seo', '@nuxt/content', '@nuxt/image', // 'nuxt-toc',
    'nuxt-icon', 'nuxt-og-image', '@pinia/nuxt', '@vueuse/nuxt', '@nuxtjs/mdc'],
  css: [
    '~/assets/index.scss',
  ],
  vite: {
