...
INSERT INTO "auth"."users" (
  ...
  '{"email_verified": true}',
  null,
  '2025-04-15 04:18:06.23308+00',
  '2025-04-15 04:18:06.237601+00',
  null,
  null,
  '',
  '',
...
VALUES (
  NOW(),
  '018d224c-0e49-4b6d-b57a-87299605c2b1',
  '2025-05-01 18:00:00.000000+00',
  'Join us for our monthly gaming session!',
  'May Community Gaming Night',
  'Discord'
);
...
VALUES (
  ...
  NOW(),
  true,
  1, -- References the server ID we just created
  3600 -- 1 hour uptime
);
...
VALUES (
  ARRAY['cs2.gameserver.hivecom.net', 'cs2.g.hivecom.net'],
  NOW(),
  '018d224c-0e49-4b6d-b57a-87299605c2b1',
  'Our community CS2 server for casual play',
  1, -- References the game ID we just created
  'Hivecom CS2 Community Server',
  '27015',
  'eu',
  'gameserver-cs2' -- References the container name we just created
);
