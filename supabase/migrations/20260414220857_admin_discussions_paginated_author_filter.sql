-- Migration: admin_discussions_paginated_author_filter
-- Adds a p_author_id filter parameter (uuid) to the
-- get_admin_discussions_paginated RPC so the admin table can be filtered
