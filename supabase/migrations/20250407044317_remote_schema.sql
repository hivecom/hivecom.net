...
ALTER TABLE "public"."referendum_votes" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."referendum_votes_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."referendums" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."referendums_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE POLICY "Allow authorized roles to CRUD events" ON "public"."events" TO "authenticated" USING (( SELECT "public"."authorize"('events.crud'::"public"."app_permission") AS "authorize"));

CREATE POLICY "Allow authorized roles to CRUD games" ON "public"."games" TO "authenticated" USING (( SELECT "public"."authorize"('games.crud'::"public"."app_permission") AS "authorize"));

CREATE POLICY "Allow authorized roles to CRUD gameservers" ON "public"."gameservers" TO "authenticated" USING (( SELECT "public"."authorize"('gameservers.crud'::"public"."app_permission") AS "authorize"));

CREATE POLICY "Allow authorized roles to CRUD profiles" ON "public"."profiles" TO "authenticated" USING (( SELECT "public"."authorize"('profiles.crud'::"public"."app_permission") AS "authorize"));

CREATE POLICY "Allow authorized roles to CRUD referendums" ON "public"."referendums" TO "authenticated" USING (( SELECT "public"."authorize"('referendums.crud'::"public"."app_permission") AS "authorize"));

CREATE POLICY "Allow authorized roles to CRUD user roles" ON "public"."user_roles" TO "authenticated" USING (( SELECT "public"."authorize"('gameservers.crud'::"public"."app_permission") AS "authorize"));

CREATE POLICY "Authenticated users can CRUD their own vote" ON "public"."referendum_votes" TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));

CREATE POLICY "Authenticated users can SELECT referendum votes" ON "public"."referendum_votes" FOR SELECT TO "authenticated" USING (true);

CREATE POLICY "Authenticated users can SELECT referendums" ON "public"."referendums" FOR SELECT TO "authenticated" USING (true);

CREATE POLICY "Authorized users can CRUD votes" ON "public"."referendum_votes" TO "authenticated" USING (( SELECT "public"."authorize"('referendums.crud'::"public"."app_permission") AS "authorize"));
...
CREATE POLICY "Everyone can SELECT role permissions" ON "public"."role_permissions" FOR SELECT TO "authenticated", "anon" USING (true);
...
GRANT ALL ON SEQUENCE "public"."referendum_votes_id_seq" TO "anon";

GRANT ALL ON SEQUENCE "public"."referendum_votes_id_seq" TO "authenticated";

GRANT ALL ON SEQUENCE "public"."referendum_votes_id_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."referendums_id_seq" TO "anon";

GRANT ALL ON SEQUENCE "public"."referendums_id_seq" TO "authenticated";

GRANT ALL ON SEQUENCE "public"."referendums_id_seq" TO "service_role";
