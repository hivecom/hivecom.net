...
BEGIN
  ...
  WHERE
    name = 'discord_complaint_webhook_url';
...
-- Create the trigger that fires after a new complaint is inserted
...
GRANT EXECUTE ON FUNCTION notify_discord_new_complaint() TO authenticated;
