-- Migration: admin_complaints_paginated_rpc
-- Provides a single paginated, filterable, server-side RPC for the admin
-- complaints list, replacing the current client-side fetch-all-and-slice approach.
--
-- Status values: 'new' (not acknowledged), 'acknowledged', 'responded' (has response)
...
GRANT EXECUTE ON FUNCTION public.get_admin_complaints_paginated(text, text[], integer, integer) TO authenticated;
