...
COMMENT ON COLUMN public.events.recurrence_parent_id IS 'For generated occurrence rows: the ID of the parent (template) event that defines the recurrence rule.';
