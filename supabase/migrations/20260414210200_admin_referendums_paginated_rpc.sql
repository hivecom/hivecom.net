-- Migration: admin_referendums_paginated_rpc
-- Provides a single paginated, filterable, sortable RPC for the admin
-- referendums table, replacing multiple client-side queries.
...
GRANT EXECUTE ON FUNCTION public.get_admin_referendums_paginated(text, text[], text[], text, text, integer, integer) TO authenticated;
