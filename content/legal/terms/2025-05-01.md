...
revisions: []
notes:
  - Initial published version of the Terms of Service. Establishes baseline conduct rules, account requirements, game server policies, and intellectual property terms.
---
